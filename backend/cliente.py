...
Este programa se ejecuta en cada nodo regional (cliente)
"""
...
class ClusterCliente:
    def __init__(self, servidor_host=None, servidor_port=9999):
        ...
        servidor_host: IP del servidor central (si es None, intenta auto-detectarla)
    ...
    def auto_detectar_servidor(self):
        ...
        # Escanear puerto 3000 (API) y 9999 (sockets)
    ...
    def obtener_info_disco(self):
        ...
        try:
            ...
            return {
                ...
                'iops': random.randint(150, 3000),  # Simulado
    ...
    def _datos_simulados(self):
        ...
        return {
            'nombre_disco': 'C:',
            'tipo_disco': random.choice(['SSD', 'HDD']),
            'capacidad_total': round(random.uniform(200, 2000), 2),
            'espacio_usado': round(random.uniform(50, 1500), 2),
            'espacio_libre': round(random.uniform(50, 500), 2),
            'iops': random.randint(150, 3000),
            'timestamp': datetime.now().isoformat()
        }
    ...
    def procesar_mensaje(self, mensaje):
        ...
        if tipo == 'BIENVENIDA':
            ...
            with open('cliente.log', 'a', encoding='utf-8') as f:
                f.write(f"{datetime.now()}: COMANDO: {mensaje}\n")
